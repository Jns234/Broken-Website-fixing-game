...
(function (global, factory) {
  ...
  function buildLineContent(cm, lineView) {
    ...
    var builder = {
      pre: eltP("pre", [content], "CodeMirror-line cm-line-through"), content: content,
      col: 0, pos: 0, cm: cm,
      trailingSpace: false,
    ...
    // Create checkbox input and add it to the label
    var checkbox = document.createElement("input");
    checkbox.type = "checkbox";
    checkbox.className = "cm-line-checkbox";
    var label = document.createElement("label");
    label.appendChild(checkbox);
    label.appendChild(builder.pre);
    label.className = "cm-line-label";
